...
const CourseCard = ({ level, xpAvailable, title, subtitle, progress, gradientColors }) => {
  return (
    <View style={GlobalStyles.card}>
      {/* Cabecera con Degradado (como en Figma) */}
      ...
      <View style={styles.body}>
        ...
        <View style={styles.progressBarBg}>
          <View style={[styles.progressBarFill, { width: `${progress}%`, backgroundColor: gradientColors[0] }]} />
        </View>
...
const styles = StyleSheet.create({
  ...
  progressContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 },
  progressLabel: { fontSize: 12, color: Colors.textLight },
  percentText: { fontSize: 12, color: Colors.textMain, fontWeight: 'bold' },
  progressBarBg: { height: 8, backgroundColor: Colors.border, borderRadius: 4, marginBottom: 15 },
